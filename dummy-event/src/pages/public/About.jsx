    ...
    <>
        ...
        <div className='flex flex-col w-full h-[300px] bg-purple-800 items-center justify-center mt-10'>
            ...
            <div className='items-center justify-center ml-10'>
                <p className='text-white text-5xl'>Very Responsible With Your Event</p>
                <p className='text-white'> At Jaiswal Events, we bring creativity, expertise, and precision to every occasion,
                     making us the most trusted event management company in Kolkata. With years of 
                     experience, we specialize in designing unique and memorable events, whether 
                     it’s a wedding, corporate gathering, or private celebration. Our end-to-end event 
                     management covers everything from venue selection and decorations to logistics and 
                     entertainment, ensuring a hassle-free experience for our clients. We pride 
                     ourselves on delivering high-quality services, innovative concepts, and flawless 
                     execution with the help of our professional and friendly team. Committed to 
                     excellence, we turn your vision into reality, creating unforgettable moments with 
                     perfection in every detail.</p>
            </div>
        </div>
